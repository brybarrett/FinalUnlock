...
[Demo机器人](https://t.me/FinalUnlock_bot) • [快速开始](#-一键安装) • [功能特性](#-功能特性) • [文档](#-详细文档)
...
# 管理员Chat ID (从 @userinfobot 获取，多个用逗号分隔)
CHAT_ID=你的chat_id,另一个管理员的chat_id
```
